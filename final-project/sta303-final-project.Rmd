...
# read in the data 
cust_sleep_complete_url <- "https://raw.githubusercontent.com/jeffreyz374/STA303-Work/main/final-project/data/cust_sleep_complete.Rds"
cust_sleep_complete <- readRDS(url(cust_sleep_complete_url, method = "libcurl"))

cust_dev_info_url <- "https://raw.githubusercontent.com/jeffreyz374/STA303-Work/main/final-project/data/cust_dev_info.Rds"
cust_dev_info <- readRDS(url(cust_dev_info_url, method = "libcurl"))
